...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Monster Hunter Stories 3";
  ...
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH: {
      ...
      renodx::mods::swapchain::resource_upgrade_infos.push_back({
          ...
          .dimensions = {.width = renodx::utils::resource::ResourceUpgradeInfo::ANY, .height = renodx::utils::resource::ResourceUpgradeInfo::ANY},
      });
