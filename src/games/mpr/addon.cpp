...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Metroid Prime Remastered";
  ...
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH: {
      ...
      */
      ...
      static std::vector<uint32_t> hashes = {0x86878F4, 0x484D3AE8};  // final buffer
